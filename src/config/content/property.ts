...
export const propertyPageContent = {
  ...
  hero: {
    ...
    ctas: [
      { label: firm.phone.display, href: `tel:${firm.phone.phoneHref}`, variant: "primary" },
  ...
  process: {
    ...
    body:
      "We keep each step practical and transparent, so you always know what is happening, what is needed from you, and what comes next.",
    image: {
